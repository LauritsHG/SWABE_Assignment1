...
//import * as seedData from 'MOCK_DATA_MATERIALS.json';
import seedData from './SeedDataForDb.json'; 

const dbConnection = mongoose.createConnection('mongodb://localhost:27017/orders');
const OrderModel = dbConnection.model('Order',schema)
